...
using RaythaZero.Application.Login.Queries;

namespace RaythaZero.Web.Areas.Public.Pages.Login;

public class ForgotPasswordComplete : BasePublicLoginPageModel
{
    [BindProperty]
    ...
    public async Task<IActionResult> OnPost(string token)
    {
        ...
        var command = new RaythaZero.Application.Login.Commands.CompleteForgotPassword.Command 
        { 
            Id = token,
