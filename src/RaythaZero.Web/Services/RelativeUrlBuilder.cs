...
public class RelativeUrlBuilder : IRelativeUrlBuilder
{
    ...
    public string AdminLoginUrl(string returnUrl = "") => ResolveUrlIfHttpContextAccessExists("/Login/LoginWithEmailAndPassword", new { area = "Admin", returnUrl });

    public string AdminLoginWithMagicLinkCompleteUrl(string token, string returnUrl = "") => ResolveUrlIfHttpContextAccessExists("/Login/LoginWithMagicLinkComplete", new { area = "Admin", token, returnUrl });
    ...
    public string UserLoginUrl(string returnUrl = "") => ResolveUrlIfHttpContextAccessExists("/Login/LoginWithEmailAndPassword", new { area = "Public", returnUrl });

    public string UserLoginWithMagicLinkCompleteUrl(string token, string returnUrl = "") => ResolveUrlIfHttpContextAccessExists("/Login/LoginWithMagicLinkComplete", new { area = "Public", token, returnUrl });

    public string UserForgotPasswordCompleteUrl(string token) => ResolveUrlIfHttpContextAccessExists("/Login/ForgotPasswordComplete", new { area = "Public", token });
    ...
    public string GetSingleSignOnCallbackJwtUrl(string area, string developerName, string signinUrl, string returnUrl = "")
    {
        var routeValues = new { area, developerName};

        string callbackUrl = _generator.GetUriByRouteValues(_httpContextAccessor.HttpContext, "AdminLoginWithJwt", routeValues);
    ...
    public string GetSingleSignOnCallbackSamlUrl(string area, string developerName, string samlIdpEntityId, string signinUrl, string returnUrl = "")
    {
        var routeValues = new { area, developerName };

        var acsUrl = _generator.GetUriByRouteValues(_httpContextAccessor.HttpContext, "AdminLoginWithSaml", routeValues);
